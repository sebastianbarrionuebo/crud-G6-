<?php
    function getAllStudentSubject($conn) {
    ...
    function createStudentSubject($conn, $idStudent, $idSubject, $grade) {
        var_dump($idStudent);
        var_dump($idSubject);
        var_dump($grade);
    ...
    function updateStudentSubject($conn, $id, $idStudent, $idSubject, $grade) {
